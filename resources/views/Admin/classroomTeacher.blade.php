                    ...
                    <div class="card py-3">
                        <div class="card-datatable table-responsive py-3 px-4">
                            <table id="table-content" class="datatables-basic table display">
                                ...
                                <tbody>
                                    @foreach ($classroomTeacher as $index => $item)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title mx-auto my-1" id="exampleModalLabel1">WALI KELAS</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('admin.classroom_teacher.store') }}" method="POST">
                    @csrf
                    <div class="modal-body row py-0">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <label class="form-label" for="class_id">Siswa</label>
                ...
                <form id="form-update" method="POST">
                    ...
                    <div class="modal-body row py-0" id="div-update">
                        <div class="modal-body row py-0">
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <label class="form-label" for="class_id-update">Siswa</label>
                                <select id="class_id-update" name="class_id" class="select2 form-select"
                                    aria-label="Default select example">
...
@section('js')
    ...
    <script>
        $('.btn-update').click(function() {
            ...
            var class_id = $(this).data('classroom');
            var actionUrl = `classroom_teacher/${id}`;
            ...
            formUpdate.find('#class_id-update option[value="' + class_id + '"]').prop('selected', true);

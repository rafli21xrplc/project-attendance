                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button data-id="{{ $item->id }}" data-name="{{ $item->name }}"
                                                    data-amount="{{ $item->amount }}" type="button"
                ...
                <form action="{{ route('admin.payment.store') }}" method="POST">
                    ...
                    <div class="modal-body row py-0">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select id="select2Multiple" class="select2 form-select custom-select" multiple>
                                        ...
                                        <tbody>
                                            @foreach ($student as $index => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->name }}</td>
                                                    <td>
                                                        <button type="button" class="btn btn-label-success btn-add">
...
@section('js')
    <script>
        ...
        // Example event listener for the plus button
        document.querySelectorAll('.btn-add').forEach(function(button) {
            button.addEventListener('click', function() {
                const studentId = this.closest('tr').querySelector('.student-checkbox').value;
                const studentName = this.closest('tr').querySelector('td:nth-child(3)').innerText;
                alert('Add action for student: ' + studentName + ' (ID: ' + studentId + ')');

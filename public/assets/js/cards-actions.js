...
!(function () {
    ...
    let t = document.getElementById("sortable-4");
    e &&
        e.map(function (e) {
            e.addEventListener("click", (l) => {
                l.preventDefault(),
                    new bootstrap.Collapse(
                        e.closest(".card").querySelector(".collapse")
                    ),
        ...
        document.addEventListener("keyup", (e) => {
            if ((e.preventDefault(), "Escape" === e.key)) {
                const e = document.querySelector(".card-fullscreen");
                e &&
                    (Helpers._toggleClass(
        ...
        void 0 !== typeof t &&
            null !== t &&
            Sortable.create(t, { animation: 500, handle: ".card" });
})(),
    $(function () {
        const e = $(".card-reload");
        e.length &&

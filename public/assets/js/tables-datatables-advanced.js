        ...
        s.flatpickr({
            ...
            onClose: function (a, t, e) {
                var l = "",
                    r = new Date();
                null != a[0] &&
                    ((l = moment(a[0]).format("MM/DD/YYYY")), n.val(l)),
                    null != a[1] &&
                        ((r = moment(a[1]).format("MM/DD/YYYY")), o.val(r)),
            ...
            responsive: {
                details: {
                    ...
                    renderer: function (a, t, e) {
                        ...
                        return (
                            !!l &&
                            $('<table class="table"/><tbody />').append(l)
                        );
                    },
                },
            },
            ...
            !(function (a, t) {
                if (5 == a) {
                    ...
                    "" !== l &&
                        ...
                        r(a, l, s)),
                        e.dataTable().fnDraw();
                } else e.DataTable().column(a).search(t, !1, !0).draw();
